...
const FEATURES = [
	{
		...
		description:
			"Get answers to your questions quickly through crowd-sourced polling.",
	},
	{
		id: "2",
		emoji: "💰",
	...
	},
	{
		...
		description:
			"Use community wisdom to make better choices in your daily life.",
	},
];
...
export default function OnboardingScreen() {
	...
	return (
		...
		>
			<View
				style={[globalStyles(colorScheme).content, { marginTop: 60 }]}
			>
				<View style={styles(colorScheme).featuresList}>
					{FEATURES.map((feature) => (
						<View
							key={feature.id}
							style={styles(colorScheme).featureCard}
						>
							<View style={styles(colorScheme).iconContainer}>
								<Text style={styles(colorScheme).emoji}>
									{feature.emoji}
								</Text>
							</View>
							<View style={styles(colorScheme).textContainer}>
								<Text style={styles(colorScheme).featureTitle}>
									{feature.title}
								</Text>
								<Text
									style={
										styles(colorScheme).featureDescription
									}
								>
									{feature.description}
								</Text>
