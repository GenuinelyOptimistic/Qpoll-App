		...
		>
			{!isVerifying ? (
				<View>
					...
					<View style={styles(colorScheme).phoneInputContainer}>
						...
						>
							...
							/>
							<Text style={styles(colorScheme).callingCode}>
								+{callingCode}
							</Text>
						</TouchableOpacity>
						<TextInput
					...
					<Text style={styles(colorScheme).termsText}>
						...
						<Text
							...
							onPress={() =>
								Linking.openURL("https://streettalk.com/terms")
							}
						>
							Terms of Use
						</Text>
				...
				<View>
					...
					<Text
						style={[
							globalStyles(colorScheme).subtitle,
							{ color: iconColor },
						]}
					>
						your code was sent to +{callingCode + " " + phoneNumber}
					</Text>
					...
					<TouchableOpacity
						style={[
							...
							{
								opacity:
									verificationCode.length === 6 ? 1 : 0.5,
							},
						]}
					...
					{countdown > 0 ? (
						<Text style={styles(colorScheme).timerText}>
