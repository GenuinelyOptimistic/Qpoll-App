...
type AvatarStyle = 'avataaars' | 'lorelei' | 'micah' | 'adventurer' | 'bottts' | 'pixel-art';
...
const styleNames: AvatarStyle[] = ['avataaars', 'lorelei', 'micah', 'adventurer', 'bottts', 'pixel-art'];
            ...
            {avatars.map((avatar) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedAvatar === avatar.id && styles.avatarContainerSelected,
                ]}
