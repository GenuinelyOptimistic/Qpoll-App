	...
	return (
		...
		>
			<View style={styles(colorScheme).header}>
				...
				<Text style={styles(colorScheme).title}>Support</Text>
				<View style={{ width: 40 }} />
			</View>

			<ScrollView style={styles(colorScheme).content}>
				<Text style={styles(colorScheme).contentText}>
					This is the Support page. Here you can find help resources
					and contact support.
				</Text>
				<View style={styles(colorScheme).dummyContent}>
					...
					<Text style={styles(colorScheme).dummyText}>
						Reach out to our support team for personalized
						assistance.
					</Text>
				</View>
			</ScrollView>
